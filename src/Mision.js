  ...
  return (
    <div className="fondo">
      ...
      <h2 className="h2">
        ...
        accesible para aquellos que buscan un servicio de barbería de calidad, y
        nos comprometemos a brindar una experiencia de usuario fluida y
        satisfactoria en cada visita a nuestra página web.
      </h2>
    </div>
  );
}
